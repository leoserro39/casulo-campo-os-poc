...
PHASE = "PROD-4581..4620"
REQ_TAG = "product-controlled-pilot-manual-dry-run-session-operator-start-packet-v0.1"

PREV_OUT = ROOT / "outputs/prod4541_4580_controlled_pilot_manual_dry_run_session_operator_start_packet.json"
...
DOC = ROOT / "docs/product/616_CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_OPERATOR_START_READINESS_GATE.md"
CONTRACT = ROOT / "product/contracts/controlled_pilot_manual_dry_run_session_operator_start_readiness_gate.contract.json"
GATE = ROOT / "product/memory/controlled_pilot_manual_dry_run_session_operator_start_readiness_gate_v0_1.json"
CAL_GATE = ROOT / "product/calibration/real_sessions/controlled_pilot_manual_dry_run_session_operator_start_readiness_gate_v0_1.json"
OUT_JSON = ROOT / "outputs/prod4581_4620_controlled_pilot_manual_dry_run_session_operator_start_readiness_gate.json"
OUT_MD = ROOT / "outputs/prod4581_4620_controlled_pilot_manual_dry_run_session_operator_start_readiness_gate.md"

READINESS_CHECKS = [
    "operator_start_packet_passed",
    ...
    "precheck_decision_ref_field_present",
    "operator_start_decision_field_present",
    "operator_start_reason_field_present",
    "start_hold_status_field_present",
    "stop_before_execution_confirmation_field_present",
    ...
    "execution_plan_packet_preparation_only"
]

ALLOWED = [
    "operator_start_readiness_gate_creation",
    "execution_plan_packet_preparation",
    "sanitized_operator_start_template_validation",
    "operator_start_hold_validation",
...
def main():
    ...
    decision = "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_PLAN_PACKET_PREPARATION_ONLY"
    ...
    gate = {
        "version": "controlled_pilot_manual_dry_run_session_operator_start_readiness_gate.v0.1",
        "phase": PHASE,
        "decision": decision,
        "purpose": "Validate operator start packet readiness before preparing execution plan packet.",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "operator_start_readiness_gate_only": True,
        ...
        "execution_plan_boundary": {
            "next_step_is_execution_plan_packet_preparation_only": True,
        ...
        "recommended_next_phase": "PROD-4621..4660 - Controlled Pilot Manual Dry Run Session Execution Plan Packet"
    }

    contract = {
        "phase": PHASE,
        "required_prior_tag": REQ_TAG,
        "mode": "controlled_pilot_manual_dry_run_session_operator_start_readiness_gate",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "operator_start_readiness_gate_only": True,
        "execution_plan_packet_preparation_only": True,
        "session_execution_not_performed": True,
    ...
    doc = """# PROD-4581..4620 - Controlled Pilot Manual Dry Run Session Operator Start Readiness Gate
...
"""
    ...
    checks = {
        ...
        "previous_operator_start_packet_ready": prev.get("decision") == "CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_OPERATOR_START_PACKET_READY",
        ...
        "has_operator_start_packet_id": "operator_start_packet_id" in operator_start_template_fields,
        "has_precheck_readiness_gate_ref": "precheck_readiness_gate_ref" in operator_start_template_fields,
        "has_precheck_packet_ref": "precheck_packet_ref" in operator_start_template_fields,
        "has_operator_ref": "operator_ref" in operator_start_template_fields,
        "has_reviewer_ref": "human_reviewer_ref" in operator_start_template_fields,
        "has_source_refs": "source_reference_refs" in operator_start_template_fields,
        "has_privacy_review_ref": "privacy_review_ref" in operator_start_template_fields,
        "has_pii_redaction_ref": "pii_redaction_ref" in operator_start_template_fields,
        "has_secret_scan_ref": "secret_scan_ref" in operator_start_template_fields,
        "has_evidence_packet_ref": "evidence_packet_ref" in operator_start_template_fields,
        "has_manual_observation_refs": "manual_observation_refs" in operator_start_template_fields,
        "has_reviewer_notes_ref": "reviewer_notes_ref" in operator_start_template_fields,
        "has_claim_boundary_review": "claim_boundary_review" in operator_start_template_fields,
        "has_dataset_hold_reason": "dataset_hold_reason" in operator_start_template_fields,
        "has_blocked_action_review": "blocked_action_review" in operator_start_template_fields,
        "has_abort_trigger_review": "abort_trigger_review" in operator_start_template_fields,
        "has_precheck_decision_ref": "precheck_decision_ref" in operator_start_template_fields,
        "has_operator_start_decision": "operator_start_decision" in operator_start_template_fields,
        "has_operator_start_reason": "operator_start_reason" in operator_start_template_fields,
        "has_start_hold_status": "start_hold_status" in operator_start_template_fields,
        "has_next_allowed_phase": "next_allowed_phase" in operator_start_template_fields,
        "has_stop_before_execution_confirmation": "stop_before_execution_confirmation" in operator_start_template_fields,
        "template_status_no_execution": start_template.get("status") == "OPERATOR_START_TEMPLATE_ONLY_NO_SESSION_EXECUTION",
        "checklist_status_no_execution": start_checklist.get("status") == "CHECKLIST_TEMPLATE_ONLY_NO_SESSION_EXECUTION",
        "operator_start_packet_only": start_packet.get("operator_start_packet_only") is True,
        "operator_start_execution_not_performed": start_packet.get("session_execution_not_performed") is True,
        "operator_start_no_real_data": start_packet.get("real_data_captured_in_this_phase") is False,
        "operator_start_no_candidate_insert": start_packet.get("real_candidate_inserted") is False,
        "operator_start_no_dataset_acceptance": start_packet.get("real_candidate_accepted_to_dataset") is False,
        "start_command_not_allowed": start_packet.get("operator_start_boundary", {}).get("start_command_allowed") is False,
        "readiness_check_count": len(READINESS_CHECKS),
        "decision_execution_plan_prep_only": decision == "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_PLAN_PACKET_PREPARATION_ONLY",
        "contract_gate_only": contract["operator_start_readiness_gate_only"] is True,
        "contract_execution_plan_packet_prep_only": contract["execution_plan_packet_preparation_only"] is True,
    ...
    if checks["operator_start_template_field_count"] < 32:
        errors.append("operator_start_template_field_count below 32")
    if checks["operator_start_checklist_item_count"] < 78:
        errors.append("operator_start_checklist_item_count below 78")
    ...
    if checks["readiness_check_count"] < 83:
        errors.append("readiness_check_count below 83")
    ...
    result = {
        "status": status,
        "phase": PHASE,
        "decision": decision if status == "PASS" else "CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_OPERATOR_START_READINESS_GATE_NOT_READY",
    ...
    report = [
        ...
        "",
        "## Boundary",
        "- Operator start readiness gate only.",
