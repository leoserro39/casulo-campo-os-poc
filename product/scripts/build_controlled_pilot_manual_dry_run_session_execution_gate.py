...
PHASE = "PROD-4101..4140"
REQ_TAG = "product-controlled-pilot-manual-dry-run-session-readiness-gate-v0.1"

PREV_OUT = ROOT / "outputs/prod4061_4100_controlled_pilot_manual_dry_run_session_readiness_gate.json"
SESSION_READINESS_GATE = ROOT / "product/calibration/real_sessions/controlled_pilot_manual_dry_run_session_readiness_gate_v0_1.json"
...
DOC = ROOT / "docs/product/604_CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_EXECUTION_GATE.md"
CONTRACT = ROOT / "product/contracts/controlled_pilot_manual_dry_run_session_execution_gate.contract.json"
GATE = ROOT / "product/memory/controlled_pilot_manual_dry_run_session_execution_gate_v0_1.json"
CAL_GATE = ROOT / "product/calibration/real_sessions/controlled_pilot_manual_dry_run_session_execution_gate_v0_1.json"
OUT_JSON = ROOT / "outputs/prod4101_4140_controlled_pilot_manual_dry_run_session_execution_gate.json"
OUT_MD = ROOT / "outputs/prod4101_4140_controlled_pilot_manual_dry_run_session_execution_gate.md"

EXECUTION_GATE_CONTROLS = [
    "prior_session_readiness_gate_passed",
    ...
    "operator_and_reviewer_preflight_required",
    "source_refs_only_required",
    "privacy_review_required",
    "pii_redaction_required",
    "secret_scan_required",
    "evidence_placeholder_required",
    "reviewer_notes_placeholder_required",
    "claim_boundary_required",
    "dataset_hold_required",
    "manual_execution_log_shell_required",
...
ALLOWED = [
    "manual_dry_run_session_execution_gate_creation",
    "controlled_manual_execution_log_shell_preparation",
    "operator_and_reviewer_execution_preflight_creation",
    "manual_execution_boundary_confirmation",
...
def main():
    ...
    session_readiness = read_json(SESSION_READINESS_GATE) if SESSION_READINESS_GATE.exists() else {}
    ...
    session_readiness_checks = session_readiness.get("readiness_checks", [])
    ...
    decision = "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_LOG_PREPARATION_ONLY"
    ...
    gate = {
        "version": "controlled_pilot_manual_dry_run_session_execution_gate.v0.1",
        "phase": PHASE,
        "decision": decision,
        "purpose": "Gate manual dry run session execution and approve only execution log shell preparation.",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "session_execution_gate_only": True,
        "session_execution_not_performed": True,
        "execution_gate_controls": EXECUTION_GATE_CONTROLS,
        ...
        "execution_boundary": {
            "next_step_is_execution_log_shell_preparation_only": True,
        ...
        "recommended_next_phase": "PROD-4141..4180 - Controlled Pilot Manual Dry Run Session Execution Log Shell"
    }

    contract = {
        "phase": PHASE,
        "required_prior_tag": REQ_TAG,
        "mode": "controlled_pilot_manual_dry_run_session_execution_gate",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "session_execution_gate_only": True,
        "session_execution_not_performed": True,
        "execution_log_shell_preparation_only": True,
    ...
    doc = """# PROD-4101..4140 - Controlled Pilot Manual Dry Run Session Execution Gate
...
"""
    ...
    checks = {
        ...
        "previous_decision_execution_prep_only": prev.get("decision") == "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_PREPARATION_ONLY",
        ...
        "session_readiness_gate_exists": SESSION_READINESS_GATE.exists(),
        ...
        "session_readiness_check_count": len(session_readiness_checks),
        ...
        "decision_log_shell_prep_only": decision == "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_LOG_PREPARATION_ONLY",
        "session_packet_only": session_packet.get("session_packet_only") is True,
        "session_execution_not_performed": session_packet.get("session_execution_not_performed") is True,
        "gate_execution_not_performed": gate["session_execution_not_performed"] is True,
        "contract_execution_log_shell_prep_only": contract["execution_log_shell_preparation_only"] is True,
    ...
    if checks["session_readiness_check_count"] < 30:
        errors.append("session_readiness_check_count below 30")
    ...
    result = {
        "status": status,
        "phase": PHASE,
        "decision": decision if status == "PASS" else "CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_EXECUTION_GATE_NOT_READY",
    ...
    report = [
        ...
        f"- Execution gate controls: `{len(EXECUTION_GATE_CONTROLS)}`",
    ...
    print("execution_gate_controls:", len(EXECUTION_GATE_CONTROLS))
