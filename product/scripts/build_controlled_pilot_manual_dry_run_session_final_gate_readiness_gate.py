...
PHASE = "PROD-4421..4460"
REQ_TAG = "product-controlled-pilot-manual-dry-run-session-final-gate-packet-v0.1"

PREV_OUT = ROOT / "outputs/prod4381_4420_controlled_pilot_manual_dry_run_session_final_gate_packet.json"
...
DOC = ROOT / "docs/product/612_CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_FINAL_GATE_READINESS_GATE.md"
CONTRACT = ROOT / "product/contracts/controlled_pilot_manual_dry_run_session_final_gate_readiness_gate.contract.json"
GATE = ROOT / "product/memory/controlled_pilot_manual_dry_run_session_final_gate_readiness_gate_v0_1.json"
CAL_GATE = ROOT / "product/calibration/real_sessions/controlled_pilot_manual_dry_run_session_final_gate_readiness_gate_v0_1.json"
OUT_JSON = ROOT / "outputs/prod4421_4460_controlled_pilot_manual_dry_run_session_final_gate_readiness_gate.json"
OUT_MD = ROOT / "outputs/prod4421_4460_controlled_pilot_manual_dry_run_session_final_gate_readiness_gate.md"

READINESS_CHECKS = [
    "final_gate_packet_passed",
    ...
    "final_gate_sections_present",
    "final_gate_fields_present",
    "final_gate_checks_present",
    "final_gate_template_fields_present",
    "final_gate_checklist_items_present",
    "review_refs_present",
    ...
    "final_gate_decision_field_present",
    "final_gate_reason_field_present",
    ...
    "final_gate_packet_only_confirmed",
    ...
    "execution_precheck_packet_preparation_only"
]

ALLOWED = [
    "final_gate_readiness_gate_creation",
    "execution_precheck_packet_preparation",
    "sanitized_final_gate_template_validation",
    "reviewer_final_gate_readiness_validation",
...
def main():
    ...
    decision = "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_PRECHECK_PACKET_PREPARATION_ONLY"
    ...
    gate = {
        "version": "controlled_pilot_manual_dry_run_session_final_gate_readiness_gate.v0.1",
        "phase": PHASE,
        "decision": decision,
        "purpose": "Validate final gate packet readiness before preparing manual execution precheck packet.",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "final_gate_readiness_gate_only": True,
        ...
        "execution_precheck_boundary": {
            "next_step_is_execution_precheck_packet_preparation_only": True,
        ...
        "recommended_next_phase": "PROD-4461..4500 - Controlled Pilot Manual Dry Run Session Execution Precheck Packet"
    }

    contract = {
        "phase": PHASE,
        "required_prior_tag": REQ_TAG,
        "mode": "controlled_pilot_manual_dry_run_session_final_gate_readiness_gate",
        "real_data_captured_in_this_phase": False,
        "real_candidate_inserted": False,
        "real_candidate_accepted_to_dataset": False,
        "final_gate_readiness_gate_only": True,
        "execution_precheck_packet_preparation_only": True,
        "session_execution_not_performed": True,
    ...
    doc = """# PROD-4421..4460 - Controlled Pilot Manual Dry Run Session Final Gate Readiness Gate

Validates the controlled manual dry run session final gate packet before execution precheck packet preparation.
...
It approves only preparation of the controlled manual dry run session execution precheck packet.

Boundary: final gate readiness gate only. No automatic capture, no real candidate insert, no dataset acceptance, no raw private data, no secrets, no unredacted PII, no production activation and no real-world/client-facing claim.
"""
    ...
    checks = {
        ...
        "previous_final_gate_packet_ready": prev.get("decision") == "CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_FINAL_GATE_PACKET_READY",
        ...
        "has_final_gate_packet_id": "final_gate_packet_id" in final_template_fields,
        "has_review_readiness_gate_ref": "review_readiness_gate_ref" in final_template_fields,
        "has_review_packet_ref": "review_packet_ref" in final_template_fields,
        "has_observation_packet_ref": "observation_packet_ref" in final_template_fields,
        "has_execution_log_shell_ref": "execution_log_shell_ref" in final_template_fields,
        "has_session_packet_ref": "session_packet_ref" in final_template_fields,
        "has_operator_ref": "operator_ref" in final_template_fields,
        "has_reviewer_ref": "human_reviewer_ref" in final_template_fields,
        "has_source_refs": "source_reference_refs" in final_template_fields,
        "has_privacy_review_ref": "privacy_review_ref" in final_template_fields,
        "has_pii_redaction_ref": "pii_redaction_ref" in final_template_fields,
        "has_secret_scan_ref": "secret_scan_ref" in final_template_fields,
        "has_evidence_packet_ref": "evidence_packet_ref" in final_template_fields,
        "has_manual_observation_refs": "manual_observation_refs" in final_template_fields,
        "has_reviewer_notes_ref": "reviewer_notes_ref" in final_template_fields,
        "has_claim_boundary_review": "claim_boundary_review" in final_template_fields,
        "has_dataset_hold_reason": "dataset_hold_reason" in final_template_fields,
        "has_blocked_action_review": "blocked_action_review" in final_template_fields,
        "has_final_gate_decision": "final_gate_decision" in final_template_fields,
        "has_final_gate_reason": "final_gate_reason" in final_template_fields,
        "has_next_allowed_phase": "next_allowed_phase" in final_template_fields,
        "template_status_no_execution": final_template.get("status") == "FINAL_GATE_TEMPLATE_ONLY_NO_SESSION_EXECUTION",
        "checklist_status_no_execution": final_checklist.get("status") == "CHECKLIST_TEMPLATE_ONLY_NO_SESSION_EXECUTION",
        "final_gate_packet_only": final_packet.get("final_gate_packet_only") is True,
        "final_gate_execution_not_performed": final_packet.get("session_execution_not_performed") is True,
        "final_gate_no_real_data": final_packet.get("real_data_captured_in_this_phase") is False,
        "final_gate_no_candidate_insert": final_packet.get("real_candidate_inserted") is False,
        "final_gate_no_dataset_acceptance": final_packet.get("real_candidate_accepted_to_dataset") is False,
        "readiness_check_count": len(READINESS_CHECKS),
        "decision_execution_precheck_prep_only": decision == "APPROVED_FOR_CONTROLLED_MANUAL_DRY_RUN_SESSION_EXECUTION_PRECHECK_PACKET_PREPARATION_ONLY",
        "contract_gate_only": contract["final_gate_readiness_gate_only"] is True,
        "contract_execution_precheck_prep_only": contract["execution_precheck_packet_preparation_only"] is True,
    ...
    if checks["final_gate_template_field_count"] < 24:
        errors.append("final_gate_template_field_count below 24")
    if checks["final_gate_checklist_item_count"] < 53:
        errors.append("final_gate_checklist_item_count below 53")
    ...
    if checks["readiness_check_count"] < 60:
        errors.append("readiness_check_count below 60")
    ...
    result = {
        "status": status,
        "phase": PHASE,
        "decision": decision if status == "PASS" else "CONTROLLED_PILOT_MANUAL_DRY_RUN_SESSION_FINAL_GATE_READINESS_GATE_NOT_READY",
    ...
    report = [
        "# PROD-4421..4460 Controlled Pilot Manual Dry Run Session Final Gate Readiness Gate",
        "",
        f"- Status: `{status}`",
        f"- Decision: `{result['decision']}`",
        f"- Readiness checks: `{len(READINESS_CHECKS)}`",
        f"- Final gate sections: `{len(final_gate_sections)}`",
        f"- Final gate fields: `{len(final_gate_fields)}`",
        f"- Final gate checks: `{len(final_gate_checks)}`",
        ...
        "",
        "## Boundary",
        "- Final gate readiness gate only.",
    ...
    print("final_gate_sections:", len(final_gate_sections))
    print("final_gate_fields:", len(final_gate_fields))
    print("final_gate_checks:", len(final_gate_checks))
