...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build CASULO controlled test report pack.")
    ...
    mode.add_argument("--write", action="store_true", help="Write report pack explicitly.")
    parser.add_argument("--output-root", default=str(ROOT / "runtime_outputs" / "controlled_test_reports"))
    parser.add_argument("--stable-time", action="store_true", default=True)
    args = parser.parse_args()

    result = run_controlled_test_report_pack(
