...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build controlled diagnostic case from real intake.")
    ...
    mode.add_argument("--write", action="store_true", help="Write evidence_manifest and case.json export.")
    parser.add_argument("--output-root", default=str(ROOT / "runtime_outputs" / "real_intake"))
